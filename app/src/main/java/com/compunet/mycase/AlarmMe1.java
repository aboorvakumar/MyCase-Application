...
public class AlarmMe1 extends Activity
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        pref.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AlarmMe1.this, Preferences.class);
...

        {
            ...
            Intent intent1 = new Intent(getBaseContext(), EditAlarm.class);
            mCurrentAlarm = new Alarm(this);
            mCurrentAlarm.toIntent(intent1);
            AlarmMe1.this.startActivityForResult(intent1, NEW_ALARM_ACTIVITY);
...
//    mAlarmListAdapter.save();
    ...
    public void onAddAlarmClick(View view)
    {
        ...
        AlarmMe1.this.startActivityForResult(intent, NEW_ALARM_ACTIVITY);
    }
    ...
    private AdapterView.OnItemClickListener mListOnItemClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> parent, View view, int position, long id)
        {
            ...
            mCurrentAlarm.toIntent(intent);
            AlarmMe1.this.startActivityForResult(intent, EDIT_ALARM_ACTIVITY);
        }
    };
